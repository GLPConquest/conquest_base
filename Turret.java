...
/*
* This class is used to build the Turret unit, an heavy ranged vehicle
...
public class Turret extends Armored{
	...
	* Custom constructor
	*/
	public Turret(Stats stats, float maxHealth, float currentHealth, Position position, int faction, float movement, int range, Resources upkeep) {
