...
/*
* This class is used to build the BFG-9000 unit, a snake like ranged bot
...
public class Bfgninethousand extends Bots{
	...
	* Custom constructor
	*/
	public Bfgninethousand(Stats stats, float maxHealth, float currentHealth, Position position, int faction, float movement, int range, Resources upkeep) {
