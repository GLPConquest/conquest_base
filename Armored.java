...
public class Armored extends Unit{
	...
	* Custom Constructor 
	*/
	public Armored(Stats stats, float maxHealth, float currentHealth, Position position, int faction, float movement, int range, Resources upkeep, ArrayList<int> crossable) {
